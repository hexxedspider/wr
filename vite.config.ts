...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [million.vite({ auto: true, mute: true }), handlebars({
      vars: {
      ...
      manifest: {
        name: "WeirdRyn",
        short_name: "WeirdRyn",
        description: "Watch movies and TV shows for free on WeirdRyn",
        theme_color: "#120f1d",
    ...
    }), splitVendorChunkPlugin(), visualizer() as PluginOption, cloudflare()],
